...
Pay special attention to the following fields: 'roastLevel', 'waterTemperature', 'acidityIntensity', 'bodyIntensity', 'uniformity', 'cleanCup', 'sweetness', 'defects', and 'aromaCategory'.
...
- If an 'aromaCategory' is provided, use it to guide your description of the aroma and flavor. For example, if the category is 'Frutal', describe specific fruit notes you might expect.
...
- Analyze the 'defects' score. If it's greater than zero, it means taints (intensity 2) or faults (intensity 4) were detected. Explain what this implies about the coffee's quality and what might have caused these defects.
